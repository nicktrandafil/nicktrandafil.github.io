...
* Portable zip: <a href="/other/Locally-Portable-1.5.17-x64.zip">v1.5.17</a>
* Installer <a href="/other/Locally-Installer-1.5.17-x64.exe">v1.5.17</a>

### Linux

* Arch Linux: <a href="/other/archlinux-locally-1.5.17-1-x86_64.pkg.tar.zst">v1.5.17</a>

#### Debian based (*.deb)

* Ubuntu 24.04: <a href="/other/ubuntu_24.04_locally_1.5.17_amd64.deb">v1.5.17</a>
* Ubuntu 22.04: <a href="/other/ubuntu_22.04_locally_1.5.17_amd64.deb">v1.5.17</a>
* Kubuntu 22.04: <a href="/other/ubuntu_22.04_locally_1.5.17_amd64.deb">v1.5.17</a>

#### Red Hat based (*.rpm)

* OpenSUSE Tumbleweed: <a href="/other/opensuse-tumbleweed-locally-1.5.17-1.x86_64.rpm">v1.5.17</a>
